...
from domainbed.classnames import *
...
if __name__ == "__main__":
    ...
    elif 'OfficeHome' in args.dataset:
        classnames = OfficeHome_classes
    elif 'VLCS' in args.dataset:
    ...
    if args.dataset in vars(datasets):
        dataset = vars(datasets)[args.dataset](args.data_dir,
                                               args.test_envs, hparams, clip_transform=preprocess)
    else:
    ...
    algorithm = algorithm_class(dataset.input_shape, dataset.num_classes,
                                len(dataset) - len(args.test_envs), hparams, classnames, clip_model)
    
    preprocess = algorithm.return_transform
