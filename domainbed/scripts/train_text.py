...
if __name__ == "__main__":
    ...
    parser.add_argument('--text_dir', type=str, default="./domainbed/pseudo_label/PACS_txt_clip_b")
    parser.add_argument('--text_dir2', type=str, default="")
    ...
    if args.dataset in vars(datasets):
        dataset = vars(datasets)[args.dataset](args.data_dir,
                                               args.test_envs, hparams, args.gen_data_dir, args.train_gen_dir, args.text_dir, args.text_dir2)
    else:
